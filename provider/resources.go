...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-argocd/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-argocd/main.go, replace the
		...
		// convention is to have a function at "github.com/argoproj-labs/terraform-provider-argocd/provider".New
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/Three141/pulumi-argocd/sdk/",
