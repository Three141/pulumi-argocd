...
- binary: pulumi-resource-argocd
  ...
  ignore: []
  ldflags:
  - -X github.com/three141/pulumi-argocd/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-argocd_darwin_amd64_v1
│   └── pulumi-resource-argocd
├── pulumi-argocd_darwin_arm64
│   └── pulumi-resource-argocd
├── pulumi-argocd_linux_amd64_v1
│   └── pulumi-resource-argocd
├── pulumi-argocd_linux_arm64
│   └── pulumi-resource-argocd
├── pulumi-argocd_windows_amd64_v1
│   └── pulumi-resource-argocd.exe
└── pulumi-argocd_windows_arm64
    └── pulumi-resource-argocd.exe
```
