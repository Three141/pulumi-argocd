...
class GpgKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] public_key: Raw key data of the GPG key to create
        """
...
class _GpgKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fingerprint: Fingerprint is the fingerprint of the key
        :param pulumi.Input[_builtins.str] owner: Owner holds the owner identification, e.g. a name and e-mail address
        :param pulumi.Input[_builtins.str] public_key: Raw key data of the GPG key to create
        :param pulumi.Input[_builtins.str] sub_type: SubType holds the key's sub type (e.g. rsa4096)
        :param pulumi.Input[_builtins.str] trust: Trust holds the level of trust assigned to this key
        """
...
@pulumi.type_token("argocd:index/gpgKey:GpgKey")
class GpgKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def trust(self) -> pulumi.Output[_builtins.str]:
        """
        Trust holds the level of trust assigned to this key
        """
        return pulumi.get(self, "trust")
