...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] sync: Trigger sync immediately after create/update. Helps in case when a Sync window is defined. It is required that the sync window is defined with `manual_sync = true`.
