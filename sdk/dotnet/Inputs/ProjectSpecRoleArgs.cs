...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ProjectSpecRoleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("jwtTokens")]
        private InputList<Inputs.ProjectSpecRoleJwtTokenArgs>? _jwtTokens;

        /// <summary>
        /// List of JWT tokens issued for this role.
        /// </summary>
        public InputList<Inputs.ProjectSpecRoleJwtTokenArgs> JwtTokens
        {
            get => _jwtTokens ?? (_jwtTokens = new InputList<Inputs.ProjectSpecRoleJwtTokenArgs>());
