...
namespace Three14.Argocd.Inputs
{
    ...
    public sealed class ProjectSpecRoleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("jwtTokens")]
        private InputList<Inputs.ProjectSpecRoleJwtTokenGetArgs>? _jwtTokens;

        /// <summary>
        /// List of JWT tokens issued for this role.
        /// </summary>
        public InputList<Inputs.ProjectSpecRoleJwtTokenGetArgs> JwtTokens
        {
            get => _jwtTokens ?? (_jwtTokens = new InputList<Inputs.ProjectSpecRoleJwtTokenGetArgs>());
