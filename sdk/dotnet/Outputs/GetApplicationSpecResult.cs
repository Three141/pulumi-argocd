...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class GetApplicationSpecResult
    {
        /// <summary>
        /// Reference to the Kubernetes server and namespace in which the application will be deployed.
        /// </summary>
        public readonly Outputs.GetApplicationSpecDestinationResult Destination;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetApplicationSpecIgnoreDifferenceResult> IgnoreDifferences;
        /// <summary>
        /// List of information (URLs, email addresses, and plain text) that relates to the application.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetApplicationSpecInfoResult> Infos;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetApplicationSpecSourceResult> Sources;
        /// <summary>
        /// Controls when and how a sync will be performed.
        /// </summary>
        public readonly Outputs.GetApplicationSpecSyncPolicyResult SyncPolicy;

        [OutputConstructor]
        private GetApplicationSpecResult(
            Outputs.GetApplicationSpecDestinationResult destination,

            ImmutableArray<Outputs.GetApplicationSpecIgnoreDifferenceResult> ignoreDifferences,

            ImmutableArray<Outputs.GetApplicationSpecInfoResult> infos,

            string project,

            int revisionHistoryLimit,

            ImmutableArray<Outputs.GetApplicationSpecSourceResult> sources,

            Outputs.GetApplicationSpecSyncPolicyResult syncPolicy)
        {
