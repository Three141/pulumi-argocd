...
export class AccountToken extends pulumi.CustomResource {
   ...
   */
  public readonly /*out*/ issuedAt!: pulumi.Output<string>;
  /**
   * The raw JWT.
   */
  public readonly /*out*/ jwt!: pulumi.Output<string>;
  /**
  ...
  constructor(
    name: string,
    argsOrState?: AccountTokenArgs | AccountTokenState,
    opts?: pulumi.CustomResourceOptions
  ) {
