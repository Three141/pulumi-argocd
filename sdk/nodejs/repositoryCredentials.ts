...
export class RepositoryCredentials extends pulumi.CustomResource {
  ...
  public static get(
    ...
    state?: RepositoryCredentialsState,
   ...
   */
  public readonly githubappEnterpriseBaseUrl!: pulumi.Output<
    string | undefined
  >;
  /**
  ...
  constructor(
    name: string,
    argsOrState?: RepositoryCredentialsArgs | RepositoryCredentialsState,
    opts?: pulumi.CustomResourceOptions
  ) {
    ...
    if (opts.id) {
      ...
      resourceInputs["githubappEnterpriseBaseUrl"] = state
        ? state.githubappEnterpriseBaseUrl
        : undefined;
      resourceInputs["githubappId"] = state ? state.githubappId : undefined;
      resourceInputs["githubappInstallationId"] = state
        ? state.githubappInstallationId
        : undefined;
      resourceInputs["githubappPrivateKey"] = state
        ? state.githubappPrivateKey
        : undefined;
      resourceInputs["password"] = state ? state.password : undefined;
      resourceInputs["sshPrivateKey"] = state ? state.sshPrivateKey : undefined;
      resourceInputs["tlsClientCertData"] = state
        ? state.tlsClientCertData
        : undefined;
      resourceInputs["tlsClientCertKey"] = state
        ? state.tlsClientCertKey
        : undefined;
      ...
      resourceInputs["githubappEnterpriseBaseUrl"] = args
        ? args.githubappEnterpriseBaseUrl
        : undefined;
      resourceInputs["githubappId"] = args ? args.githubappId : undefined;
      resourceInputs["githubappInstallationId"] = args
        ? args.githubappInstallationId
        : undefined;
      resourceInputs["githubappPrivateKey"] = args?.githubappPrivateKey
        ? pulumi.secret(args.githubappPrivateKey)
        : undefined;
      resourceInputs["password"] = args?.password
        ? pulumi.secret(args.password)
        : undefined;
      resourceInputs["sshPrivateKey"] = args?.sshPrivateKey
        ? pulumi.secret(args.sshPrivateKey)
        : undefined;
      resourceInputs["tlsClientCertData"] = args
        ? args.tlsClientCertData
        : undefined;
      resourceInputs["tlsClientCertKey"] = args?.tlsClientCertKey
        ? pulumi.secret(args.tlsClientCertKey)
        : undefined;
