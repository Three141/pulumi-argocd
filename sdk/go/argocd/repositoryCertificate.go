...
type RepositoryCertificate struct {
	...
	Https RepositoryCertificateHttpArrayOutput `pulumi:"https"`
	// SSH certificate configuration
	Sshes RepositoryCertificateSshArrayOutput `pulumi:"sshes"`
}
...
type repositoryCertificateState struct {
	// HTTPS certificate configuration
	Https []RepositoryCertificateHttp `pulumi:"https"`
	// SSH certificate configuration
	Sshes []RepositoryCertificateSsh `pulumi:"sshes"`
}

type RepositoryCertificateState struct {
	// HTTPS certificate configuration
	Https RepositoryCertificateHttpArrayInput
	// SSH certificate configuration
	Sshes RepositoryCertificateSshArrayInput
}
...
// HTTPS certificate configuration
func (o RepositoryCertificateOutput) Https() RepositoryCertificateHttpArrayOutput {
	return o.ApplyT(func(v *RepositoryCertificate) RepositoryCertificateHttpArrayOutput { return v.Https }).(RepositoryCertificateHttpArrayOutput)
}

// SSH certificate configuration
func (o RepositoryCertificateOutput) Sshes() RepositoryCertificateSshArrayOutput {
	return o.ApplyT(func(v *RepositoryCertificate) RepositoryCertificateSshArrayOutput { return v.Sshes }).(RepositoryCertificateSshArrayOutput)
}
