...
// Whether `helm-oci` support should be enabled for this repo. Can only be set to `true` when `type` is `helm`.
func (o RepositoryCredentialsOutput) EnableOci() pulumi.BoolOutput {
	return o.ApplyT(func(v *RepositoryCredentials) pulumi.BoolOutput { return v.EnableOci }).(pulumi.BoolOutput)
}
...
// Type of the repository credentials. Can be either `git`, `oci` or `helm`. `git` is assumed if empty or absent.
func (o RepositoryCredentialsOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *RepositoryCredentials) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}
...
// Whether `Azure-Workload-identity` should be enabled for this repository.
func (o RepositoryCredentialsOutput) UseAzureWorkloadIdentity() pulumi.BoolOutput {
	return o.ApplyT(func(v *RepositoryCredentials) pulumi.BoolOutput { return v.UseAzureWorkloadIdentity }).(pulumi.BoolOutput)
}
