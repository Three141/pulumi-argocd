...
type Repository struct {
	...
	EnableOci pulumi.BoolOutput `pulumi:"enableOci"`
	// GitHub API URL for GitHub app authentication.
	GithubappEnterpriseBaseUrl pulumi.StringOutput `pulumi:"githubappEnterpriseBaseUrl"`
	// ID of the GitHub app used to access the repo.
	GithubappId pulumi.StringOutput `pulumi:"githubappId"`
	// The installation ID of the GitHub App used to access the repo.
	GithubappInstallationId pulumi.StringOutput `pulumi:"githubappInstallationId"`
	...
	UseAzureWorkloadIdentity pulumi.BoolOutput `pulumi:"useAzureWorkloadIdentity"`
...
type repositoryState struct {
	...
	// Whether `Azure-Workload-identity` should be enabled for this repository.
	UseAzureWorkloadIdentity *bool `pulumi:"useAzureWorkloadIdentity"`
	// Username used for authenticating at the remote repository.
...
type RepositoryState struct {
	...
	// Whether `Azure-Workload-identity` should be enabled for this repository.
	UseAzureWorkloadIdentity pulumi.BoolPtrInput
	// Username used for authenticating at the remote repository.
...
// BearerToken contains the bearer token used for Git BitBucket Data Center auth at the repo server
func (o RepositoryOutput) BearerToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringPtrOutput { return v.BearerToken }).(pulumi.StringPtrOutput)
}
...
// Whether `git-lfs` support should be enabled for this repository.
func (o RepositoryOutput) EnableLfs() pulumi.BoolOutput {
	return o.ApplyT(func(v *Repository) pulumi.BoolOutput { return v.EnableLfs }).(pulumi.BoolOutput)
}

// Whether `helm-oci` support should be enabled for this repository.
func (o RepositoryOutput) EnableOci() pulumi.BoolOutput {
	return o.ApplyT(func(v *Repository) pulumi.BoolOutput { return v.EnableOci }).(pulumi.BoolOutput)
}

// GitHub API URL for GitHub app authentication.
func (o RepositoryOutput) GithubappEnterpriseBaseUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringOutput { return v.GithubappEnterpriseBaseUrl }).(pulumi.StringOutput)
}

// ID of the GitHub app used to access the repo.
func (o RepositoryOutput) GithubappId() pulumi.StringOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringOutput { return v.GithubappId }).(pulumi.StringOutput)
}

// The installation ID of the GitHub App used to access the repo.
func (o RepositoryOutput) GithubappInstallationId() pulumi.StringOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringOutput { return v.GithubappInstallationId }).(pulumi.StringOutput)
}
...
// Whether the connection to the repository ignores any errors when verifying TLS certificates or SSH host keys.
func (o RepositoryOutput) Insecure() pulumi.BoolOutput {
	return o.ApplyT(func(v *Repository) pulumi.BoolOutput { return v.Insecure }).(pulumi.BoolOutput)
}
...
// Comma-separated list of hostnames that should be excluded from proxying.
func (o RepositoryOutput) NoProxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringPtrOutput { return v.NoProxy }).(pulumi.StringPtrOutput)
}
...
// HTTP/HTTPS proxy to access the repository.
func (o RepositoryOutput) Proxy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringPtrOutput { return v.Proxy }).(pulumi.StringPtrOutput)
}
...
// Type of the repo. Can be either `git`, `helm` or `oci`. `git` is assumed if empty or absent.
func (o RepositoryOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *Repository) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}

// Whether `Azure-Workload-identity` should be enabled for this repository.
func (o RepositoryOutput) UseAzureWorkloadIdentity() pulumi.BoolOutput {
	return o.ApplyT(func(v *Repository) pulumi.BoolOutput { return v.UseAzureWorkloadIdentity }).(pulumi.BoolOutput)
}
